...
aplicacion.geometry('1150x630+0+0')  # +0+0 es para decir donde queremos que aparezca la pantalla
...
aplicacion.config(bg='burlywood')  # se pueden poner nombres de colores en inglés o el número rgb de web
